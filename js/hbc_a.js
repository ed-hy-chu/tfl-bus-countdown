...
function drawData() {
    ...
    ctx.fillText('Hackbridge Corner', 40, 150);

    ctx.font = "22px Railway";
    ctx.fillStyle = '#000000';
    ctx.fillText('towards Tooting Broadway', 60, 210);
    ctx.fillText('or Wallington', 115, 235);
...
async function fetchData() {
    let dataurl = 'https://api.tfl.gov.uk/StopPoint/490007616A/arrivals'; //Hackbridge Corner (Southbound / Eastbound)
