...
function drawData() {
    ...
    //Stop name
    ctx.font = "28px Railway";
    ctx.fillStyle = '#ffffff';
    ctx.fillText('Westminster / Parliament Sq', 12, 150);

    ctx.font = "22px Railway";
    ctx.fillStyle = '#000000';
    ctx.fillText('towards Tottenham Ct. Rd.', 60, 210);
    ctx.fillText('Aldwych or Piccadilly Circus', 54, 235);
...
async function fetchData() {
    let dataurl = 'https://api.tfl.gov.uk/StopPoint/490000266G/arrivals';
