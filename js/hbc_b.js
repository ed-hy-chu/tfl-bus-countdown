...
function drawData() {
    ...
    ctx.fillText('Hackbridge Station', 40, 150);

    ctx.font = "22px Railway";
    ctx.fillStyle = '#000000';
    ctx.fillText('towards Rosehill', 102, 210);
    ctx.fillText('or Worcester Park', 97, 235);
...
async function fetchData() {
    let dataurl = 'https://api.tfl.gov.uk/StopPoint/490007616N/arrivals'; //Hackbridge Corner (Northbound / Westbound)
